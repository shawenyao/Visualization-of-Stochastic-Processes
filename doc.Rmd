...
In this post, we visualize the evolution of stochastic process distribution along the following 3 diemensions

* $t$: time
* $x$: the value of the stochastic process at time $t$
* $f(x)$: the probability density of $x$ at time $t$

Note that expected value at each time $t$ are also highlighted.
